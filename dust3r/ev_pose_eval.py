...
from dust3r.utils.image import load_ev_images
...
def eval_pose_estimation_dist(args, model, device, img_path, save_dir=None, mask_path=None):
    ...
    for seq in tqdm(seq_list):
        try:
            ...
            if args.eval_dataset == 'pointodyssey':
                filelist = dir_path  # dir_path is actually the full path list here
                scene_graph_type = args.scene_graph_type
                # swinstride-5-noncyclic
            ...
            imgs = load_ev_images(
                ...
                dynamic_mask_root=mask_path_seq, crop=not args.no_crop, num_frames=10
            )
