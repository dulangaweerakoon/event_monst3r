...
# python launch.py  --mode=train \
#     --train_dataset="10_000 @ EventVoxelPointOdysseyDUSt3R(dset='train', z_far=80, dataset_location='data/point_odyssey', S=2, aug_crop=16, resolution=[(512, 288), (512, 384), (512, 336)], transform=ColorJitter, strides=[1,2,3,4,5,6,7,8,9], dist_type='linear_1_2', aug_focal=0.9)"   \
#     --test_dataset="1000 @ EventVoxelPointOdysseyDUSt3R(dset='test', z_far=80, dataset_location='data/point_odyssey', S=2, strides=[1,2,3,4,5,6,7,8,9], resolution=[(512, 288)], seed=777)"   \
...
#     --lr=0.00005 --min_lr=1e-06 --warmup_epochs=3 --epochs=50 --batch_size=2 --accum_iter=4  \
#     --save_freq=3 --keep_freq=5 --eval_freq=1  \
#     --output_dir="results2/MonST3R_PO_EventVoxels" #> results2/MonST3R_PO_EventVoxels.txt 2>&1

#Object Aware
# python launch.py  --mode=train \
#     --train_dataset="10_000 @ EventVoxelPointOdysseyDUSt3R(dset='train', z_far=80, dataset_location='data/point_odyssey', S=2, aug_crop=16, resolution=[(512, 288), (512, 384), (512, 336)], transform=ColorJitter, strides=[1,2,3,4,5,6,7,8,9], dist_type='linear_1_2', aug_focal=0.9)"   \
#     --test_dataset="1000 @ EventVoxelPointOdysseyDUSt3R(dset='test', z_far=80, dataset_location='data/point_odyssey', S=2, strides=[1,2,3,4,5,6,7,8,9], resolution=[(512, 288)], seed=777)"   \
#     --model="ObjectAwareDepthV1(pos_embed='RoPE100', patch_embed_cls='ManyAR_PatchEmbed', img_size=(512, 512), head_type='dpt', output_mode='pts3d', depth_mode=('exp', -inf, inf), conf_mode=('exp', 1, inf), enc_embed_dim=1024, enc_depth=24, enc_num_heads=16, dec_embed_dim=768, dec_depth=12, dec_num_heads=12, freeze='encoder')"  \
#     --train_criterion="ConfLoss(Regr3D(L21, norm_mode='avg_dis'), alpha=0.2)"  \
#     --test_criterion="Regr3D_ScaleShiftInv(L21, gt_scale=True)"   \
#     --lr=0.00005 --min_lr=1e-06 --warmup_epochs=3 --epochs=50 --batch_size=1 --accum_iter=4  \
#     --save_freq=3 --keep_freq=5 --eval_freq=1  \
#     --output_dir="results2/MonST3R_PO_ObjectAware" #> results2/MonST3R_PO_ObjectAware.txt 2>&1


python launch.py  --mode=train \
    --train_dataset="10_000 @ EventVoxelPointOdysseyDUSt3R(dset='train', z_far=80, dataset_location='data/point_odyssey', S=2, aug_crop=16, resolution=[(256,256)], transform=ColorJitter, strides=[1,2,3,4,5,6,7,8,9], dist_type='linear_1_2', aug_focal=0.9)"   \
    --test_dataset="1000 @ EventVoxelPointOdysseyDUSt3R(dset='test', z_far=80, dataset_location='data/point_odyssey', S=2, strides=[1,2,3,4,5,6,7,8,9], resolution=[(256,256)], seed=777)"   \
    --model="ObjectAwareDepthV2(pos_embed='RoPE100', patch_embed_cls='ManyAR_PatchEmbed', img_size=(512,512), head_type='dpt', output_mode='pts3d', depth_mode=('exp', -inf, inf), conf_mode=('exp', 1, inf), enc_embed_dim=1024, enc_depth=24, enc_num_heads=16, dec_embed_dim=768, dec_depth=12, dec_num_heads=12, freeze='encoder')"  \
    --train_criterion="MaskedConfLoss(Regr3D(L21, norm_mode='avg_dis'), alpha=0.2)"  \
    --test_criterion="Regr3D_ScaleShiftInv(L21, gt_scale=True)"   \
    --lr=0.00005 --min_lr=1e-06 --warmup_epochs=3 --epochs=50 --batch_size=2 --accum_iter=4  \
    --save_freq=3 --keep_freq=5 --eval_freq=1  \
    --output_dir="results2/MonST3R_PO_ObjectAware" #> results2/MonST3R_PO_ObjectAware.txt 2>&1
